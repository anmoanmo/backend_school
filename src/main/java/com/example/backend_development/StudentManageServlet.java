...
@WebServlet(name = "studentManageServlet", value = "/student-manage")
public class StudentManageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        try {
            ...
            request.getRequestDispatcher("/student-manage.jsp").forward(request, response);
        } catch (SQLException e) {
            throw new ServletException("Failed to load records for management page", e);
        }
    }
}
